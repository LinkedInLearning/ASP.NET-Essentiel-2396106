...
namespace EvaluationProduit.MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<Utilisateur>().AddEntityFrameworkStores<AuthenticationContext>();
            ...
            services.AddSingleton<SignInManager<Utilisateur>>();
            services.AddSingleton<UserManager<Utilisateur>>();
